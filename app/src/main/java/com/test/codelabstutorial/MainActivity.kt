...
@Preview(showBackground = true, widthDp = 320, uiMode = UI_MODE_NIGHT_YES, name = "Default Preview Dark")
@Preview(showBackground = true, name = "Default Preview Light", widthDp = 320)
@Composable
fun DefaultPreview() {
    CodeLabsTutorialTheme {
        Greetings()
